...
//create contract for ABI to interact with the contract
const ABI = [
	{
		"inputs": [],
...
// Contract address taken from the deployed contract on Remix
const ADDRESS = "0x44b8f5B02F4925056664DDf8bE6924C18fb68De7";
...
async function mint() { //when the user hits Mint button, execute the following commands
        ...
        <div className='row'>
          <form className="gradient col-lg-5 mt-5" style={{borderRadius:"25px", boxShadow:"1px 1px 15px #000000"}}>
            ...
            <section>
              ...
              <br></br>
              <div className="card" id='wallet-address' style={{marginTop:"2px", marginBottom:"2px", boxShadow:"1px 1px 4px #000000"}}>
            ...
            <div className="card" style={{marginTop:"3px", boxShadow:"1px 1px 4px #000000"}}>
              <label style={{color: "#000000"}}>Marketplace</label>
